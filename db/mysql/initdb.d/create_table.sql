...
ALTER TABLE `area_district_code`
    ADD CONSTRAINT `PK_AREA_DISTRICT_CODE` PRIMARY KEY (
                                                        `id`
        );

ALTER TABLE `(optional)notification_read`
    ADD CONSTRAINT `PK_(OPTIONAL)NOTIFICATION_READ` PRIMARY KEY (
                                                                 `id`
        );

ALTER TABLE `confirm_email`
    ADD CONSTRAINT `PK_CONFIRM_EMAIL` PRIMARY KEY (
                                                   `id`
        );

ALTER TABLE `banner_click`
    ADD CONSTRAINT `PK_BANNER_CLICK` PRIMARY KEY (
                                                  `id`
        );
...
ALTER TABLE `area_city_code`
    ADD CONSTRAINT `PK_AREA_CITY_CODE` PRIMARY KEY (
                                                    `id`
        );

ALTER TABLE `spam_word`
    ADD CONSTRAINT `PK_SPAM_WORD` PRIMARY KEY (
                                               `id`
        );
...
ALTER TABLE `content_vote`
    ADD CONSTRAINT `PK_CONTENT_VOTE` PRIMARY KEY (
                                                  `id`
        );
...
ALTER TABLE `activity`
    ADD CONSTRAINT `PK_ACTIVITY` PRIMARY KEY (
                                              `id`
        );
...
ALTER TABLE `temp_article`
    ADD CONSTRAINT `PK_TEMP_ARTICLE` PRIMARY KEY (
                                                  `id`
        );
...
ALTER TABLE `scrap`
    ADD CONSTRAINT `FK_avatar_TO_scrap_1` FOREIGN KEY (
                                                       `avatar_id`
        )
        REFERENCES `avatar` (
                             `id`
...
ALTER TABLE `scrap`
    ADD CONSTRAINT `FK_article_TO_scrap_1` FOREIGN KEY (
                                                        `article_id`
        )
        REFERENCES `article` (
                              `id`
...
ALTER TABLE `follow`
    ADD CONSTRAINT `FK_avatar_TO_follow_1` FOREIGN KEY (
                                                        `follower_id`
        )
        REFERENCES `avatar` (
                             `id`
...
ALTER TABLE `follow`
    ADD CONSTRAINT `FK_avatar_TO_follow_2` FOREIGN KEY (
                                                        `following_id`
        )
        REFERENCES `avatar` (
                             `id`
