...
import com.chatcode.config.auth.jwt.ExternalProperties;
import com.chatcode.config.auth.jwt.JwtAuthenticationFilter;
import com.chatcode.config.auth.jwt.JwtAuthorizationFilter;
...
public class SecurityConfig {
    ...
    public class CustomSecurityFilterManager extends AbstractHttpConfigurer<CustomSecurityFilterManager, HttpSecurity> {
        ...
        public void configure(HttpSecurity builder) throws Exception {
            ...
            builder.addFilter(new JwtAuthorizationFilter(authenticationManager, externalProperties, jwtProvider));
