...
public class Comment extends TableImpl<CommentRecord> {
    ...
    /**
     * The column <code>comment.parent_id</code>.
     */
    public final TableField<CommentRecord, Long> PARENT_ID = createField(DSL.name("parent_id"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>comment.ancestor_id</code>.
     */
    public final TableField<CommentRecord, Long> ANCESTOR_ID = createField(DSL.name("ancestor_id"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>comment.depth</code>.
     */
    public final TableField<CommentRecord, Integer> DEPTH = createField(DSL.name("depth"), SQLDataType.INTEGER, this, "");
