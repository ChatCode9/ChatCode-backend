...
import com.chatcode.jooq.tables.records.ArticleTagRecord;
...
public class ArticleTag extends TableImpl<ArticleTagRecord> {
    ...
    /**
     * The column <code>article_tag.article_tags_id</code>.
     */
    public final TableField<ArticleTagRecord, Long> ARTICLE_TAGS_ID = createField(DSL.name("article_tags_id"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>article_tag.tag_id</code>.
     */
    public final TableField<ArticleTagRecord, Long> TAG_ID = createField(DSL.name("tag_id"), SQLDataType.BIGINT, this, "");
