...
public class Role extends TableImpl<RoleRecord> {
     ...
     */
    public final TableField<RoleRecord, Long> VERSION = createField(DSL.name("version"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>role.authority</code>.
     */
    public final TableField<RoleRecord, String> AUTHORITY = createField(DSL.name("authority"), SQLDataType.VARCHAR(255).nullable(false), this, "");
    ...
    public UserRolePath userRole() {
        if (_userRole == null)
            _userRole = new UserRolePath(this, null, Keys.FK_ROLE_TO_USER_ROLE_1.getInverseKey());
