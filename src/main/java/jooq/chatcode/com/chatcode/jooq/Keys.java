...
public class Keys {
    ...
    public static final UniqueKey<OpinionRecord> PK_OPINIONID = Internal.createUniqueKey(Opinion.OPINION, DSL.name("PK_OPINIONID"), new TableField[] { Opinion.OPINION.ID }, true);
