...
public class CommentRecord extends UpdatableRecordImpl<CommentRecord> {
    ...
    /**
     * Setter for <code>comment.parent_id</code>.
     */
    ...
    /**
     * Setter for <code>comment.ancestor_id</code>.
     */
    public CommentRecord setAncestorId(Long value) {
        set(10, value);
        return this;
    }
    ...
    /**
     * Setter for <code>comment.depth</code>.
     */
    public CommentRecord setDepth(Integer value) {
        set(11, value);
        return this;
    }
     ...
     */
    public CommentRecord(Long id, Long articleId, Long authorId, Long version, String comment, LocalDateTime dateCreated, LocalDateTime lastUpdated, Integer likeCount, Integer dislikeCount, Long parentId, Long ancestorId, Integer depth) {
        super(Comment.COMMENT);
